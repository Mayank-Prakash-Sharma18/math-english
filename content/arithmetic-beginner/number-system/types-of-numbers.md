...
* Negative Numbers: Numbers which are to the left of zero on the number line. <br>
...
* Case II: Sum of odd number of odd numbers is odd. E.g. 1 + 3 + 5 = 9. <br>
