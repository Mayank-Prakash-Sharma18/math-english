...
In the given series, the numbers placed at even positions are obtained by multiplying the adjacent digits. 
...
Each next term of the series (starting from the third term) can be obtained by taking the sum of the previous two terms. That is, the given series is a Fibonacci series. 
